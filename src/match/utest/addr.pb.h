...
class Person : public ::google::protobuf::Message {
 public:
  ...
  inline bool has_goodman() const;
  inline void clear_goodman();
  static const int kGoodmanFieldNumber = 5;
  inline bool goodman() const;
  inline void set_goodman(bool value);
...
// optional bool goodman = 5;
inline bool Person::has_goodman() const {
  return _has_bit(4);
}
inline void Person::clear_goodman() {
  goodman_ = false;
  _clear_bit(4);
}
inline bool Person::goodman() const {
  return goodman_;
}
inline void Person::set_goodman(bool value) {
  _set_bit(4);
  goodman_ = value;
}
